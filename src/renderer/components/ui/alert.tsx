  ...
  "relative w-full rounded-lg border px-4 py-3 text-sm [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground",
  {
    variants: {
      variant: {
        ...
        warning:
          "border-amber-500/50 text-amber-600 dark:text-amber-400 dark:border-amber-500/30",
        success:
          "border-emerald-500/50 text-emerald-600 dark:text-emerald-400 dark:border-emerald-500/30",
      },
    },
    defaultVariants: {
      variant: "default",
